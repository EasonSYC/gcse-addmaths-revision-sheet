    ...
    \section{Differentiation and integration}
        ...
        \subsection{Integration}
            \begin{definition}[indefinite integral]
                If we have a function $f(x)$, and we have a function $F(x)$ s.t. $F'(x) = f(x)$, we say $F(x)$ is an \textbf{antiderivative} of function $f(x)$. Without proof we say that $F(x)$ can form a class of functions with difference of a constant. Hence we can define the \textbf{indefinite integral} as
                $$
            ...
            \begin{theorem}[Newton--Leibniz Formula, fundamental theorem of calculus]
                ...
                \begin{proof}
                    A basic explanation is: when we 'sum' together some small increments (significance of Riemann Integral) which are derivatives of the original function, we in fact just get the increasement in the original function itself!
                \end{proof}
            \end{theorem}
